...
-- AddForeignKey
ALTER TABLE "Sale" ADD CONSTRAINT "Sale_paymentTypeId_fkey" FOREIGN KEY ("paymentTypeId") REFERENCES "PaymentType"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "StockInput" ADD CONSTRAINT "StockInput_addedById_fkey" FOREIGN KEY ("addedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
